...
// только два операнда
// римские числа
// операнды не должны быть больше 10
// не дробные числа
// результат только целое число, дробь отбрасываем
// если операнды разных систем исчисления - ошибка
// если работаем с римскими числами и ответ будет ноль, возвращаем пустую строку
// если кривое выражение - бросаем исключение
...
function calculator(expr) {
  ...
  if (operand1 == 0 || operand2 == 0)
    throw Error("Операнды болжны быть целыми положительными числами");
